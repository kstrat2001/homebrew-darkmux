...
#   brew install darkmux                # stable release (v1.6.0)
...
class Darkmux < Formula
  ...
  # Stable release: v1.6.0 (dispatch-to-PR loop correctness + lab profile-dev —
  # persist-corrections #849 + lab --profiles-file fix #984).
